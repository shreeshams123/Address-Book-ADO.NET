...
namespace Address_Book_ADO.NET
{
    public class ContactRepo
    {
        ...
        public void UpdateContact(string firstname, string lastname,string newfirstname,string newlastname, string address, string city, string state, int zip, long phone, string email)
        {
            ...
            string query = "Update Contacts set Firstname=@NewFirstName,LastName=@NewLastName,Address=@Address,City=@City,State=@State,Zip=@Zip,Phone=@Phone,Email=@Email where FirstName=@FirstName and LastName=@LastName";
            using (SqlConnection con = new SqlConnection(connectionstring))
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand(query, con))
